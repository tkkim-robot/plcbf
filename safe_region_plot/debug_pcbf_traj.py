...
from safe_region_plot.filters import PCBFWrapper
...
def debug_pcbf_traj():
    ...
    # PCBF Wrapper (Alpha=0.1)
    # Note: PCBFWrapper expects 'robot' for params mainly, but uses internal JAX dynamics for value.
    # We pass the DoubleIntegrator2D instance.
    fw = PCBFWrapper(
    ...
    out_path = 'safe_region_plot/output/debug_pcbf_traj.png'
